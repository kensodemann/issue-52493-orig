...
describe('TastingNoteEditorComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.overrideProvider(TastingNotesService, {
    ...
    describe('with a note', () => {
      ...
      it('sets the brand', () => {
        const brand = fixture.debugElement.query(
          By.css('[data-testid="brand-input"]'),
        );
      ...
      it('sets the notes', () => {
        const notes = fixture.debugElement.query(
          By.css('[data-testid="notes-input"]'),
        );
        expect(notes.nativeElement.value).toEqual(
          'Overly acidic, highly tannic flavor',
        );
      });

      it('sets the tea category id', () => {
        const sel = fixture.debugElement.query(
          By.css('[data-testid="tea-type-select"]'),
        );
  ...
  describe('share', () => {
    describe('in a web context', () => {
      ...
      it('is not available', () => {
        expect(
          fixture.debugElement.query(By.css('[data-testid="share-button"]')),
        ).toBeFalsy();
      });
    });
    ...
    describe('in a mobile context', () => {
      ...
      it('is not allowed until a brand, name, and rating have all been entered', () => {
        const button = fixture.debugElement.query(
          By.css('[data-testid="share-button"]'),
        );
